...
/**
 * Get the flags for this Pixel Format. This is a bitmask of the {@link 
 * PixelFormatDescriptor.Flag} enum values.  
 */
 ...
 */
  ...
  /**
   * Pixel format has a palette in data[1], values are indexes in this 
   * palette.
   */
  ...
  /**
   * The pixel format is "pseudo-paletted". This means that FFmpeg treats 
   * it as
   * paletted internally, but the palette is generated by the decoder 
   * and is not
   * stored in the file.
   */
