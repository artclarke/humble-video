...
// HumbleVideo.i: End generated code
  ...
  public final static native int Stream_DISPOSITION_DEFAULT_get();
  public final static native int Stream_DISPOSITION_DUB_get();
  public final static native int Stream_DISPOSITION_ORIGINAL_get();
  public final static native int Stream_DISPOSITION_COMMENT_get();
  public final static native int Stream_DISPOSITION_LYRICS_get();
  public final static native int Stream_DISPOSITION_KARAOKE_get();
  public final static native int Stream_DISPOSITION_FORCED_get();
  public final static native int Stream_DISPOSITION_HEARING_IMPAIRED_get();
  public final static native int Stream_DISPOSITION_VISUAL_IMPAIRED_get();
  public final static native int Stream_DISPOSITION_CLEAN_EFFECTS_get();
  public final static native int Stream_DISPOSITION_ATTACHED_PIC_get();
  public final static native int Stream_PARSE_NONE_get();
  public final static native int Stream_PARSE_FULL_get();
  public final static native int Stream_PARSE_HEADERS_get();
  public final static native int Stream_PARSE_TIMESTAMPS_get();
  public final static native int Stream_PARSE_FULL_ONCE_get();
  public final static native int Stream_PARSE_FULL_RAW_get();
  public final static native int Stream_getIndex(long jarg1, Stream jarg1_);
  public final static native int Stream_getId(long jarg1, Stream jarg1_);
  public final static native long Stream_getFrameRate(long jarg1, Stream jarg1_);
  public final static native long Stream_getTimeBase(long jarg1, Stream jarg1_);
  public final static native long Stream_getStartTime(long jarg1, Stream jarg1_);
  public final static native long Stream_getDuration(long jarg1, Stream jarg1_);
  public final static native long Stream_getCurrentDts(long jarg1, Stream jarg1_);
  public final static native int Stream_getNumIndexEntries(long jarg1, Stream jarg1_);
  public final static native long Stream_getNumFrames(long jarg1, Stream jarg1_);
  public final static native long Stream_getSampleAspectRatio(long jarg1, Stream jarg1_);
  public final static native long Stream_getContainer(long jarg1, Stream jarg1_);
  public final static native int Stream_getParseType(long jarg1, Stream jarg1_);
  public final static native void Stream_setParseType(long jarg1, Stream jarg1_, int jarg2);
  public final static native long Stream_getMetaData(long jarg1, Stream jarg1_);
  public final static native long Stream_findTimeStampEntryInIndex(long jarg1, Stream jarg1_, long jarg2, int jarg3);
  public final static native int Stream_findTimeStampPositionInIndex(long jarg1, Stream jarg1_, long jarg2, int jarg3);
  public final static native long Stream_getIndexEntry(long jarg1, Stream jarg1_, int jarg2);
  public final static native long Stream_getAttachedPic(long jarg1, Stream jarg1_);
  public final static native int Stream_getDisposition(long jarg1, Stream jarg1_);
