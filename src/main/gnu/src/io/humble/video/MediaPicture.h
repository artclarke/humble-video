...
#ifndef SWIG
    static PixelComponentDescriptor* make(AVComponentDescriptor* ctx);
#endif // ! SWIG
private:
    PixelComponentDescriptor() :mCtx(0) {}
    virtual ~PixelComponentDescriptor() {}
    AVComponentDescriptor* mCtx;
};
...
#ifndef SWIG
  static PixelFormatDescriptor* make(AVPixFmtDescriptor* ctx);
#endif // ! SWIG
private:
  PixelFormatDescriptor() : mCtx(0) {}
  virtual ~PixelFormatDescriptor() {}
  AVPixFmtDescriptor* mCtx;
 ...
 */
class VS_API_HUMBLEVIDEO PictureFormat : public io::humble::ferry::RefCounted
{
public:
  /**
   * Pixel format.
