...
#include <io/humble/video/io/FfmpegIO.h>
...
VS_API_HUMBLE_VIDEO_IO void VS_API_CALL Java_io_humble_video_io_FfmpegIO_init(JNIEnv *env, jclass)
{
  JavaVM* vm=0;
...
VS_API_HUMBLE_VIDEO_IO jint VS_API_CALL Java_io_humble_video_io_FfmpegIO_native_1registerProtocolHandler(
...
VS_API_HUMBLE_VIDEO_IO jint VS_API_CALL Java_io_humble_video_io_FfmpegIO_native_1url_1open(
...
VS_API_HUMBLE_VIDEO_IO jint VS_API_CALL Java_io_humble_video_io_FfmpegIO_native_1url_1read(
...
VS_API_HUMBLE_VIDEO_IO jint VS_API_CALL Java_io_humble_video_io_FfmpegIO_native_1url_1write(
    JNIEnv *jenv, jclass, jobject handle, jbyteArray javaBuf, jint buflen)
{
  URLProtocolHandler* handleVal= NULL;
...
VS_API_HUMBLE_VIDEO_IO jlong VS_API_CALL Java_io_humble_video_io_FfmpegIO_native_1url_1seek(
...
VS_API_HUMBLE_VIDEO_IO jint VS_API_CALL Java_io_humble_video_io_FfmpegIO_native_1url_1close(
