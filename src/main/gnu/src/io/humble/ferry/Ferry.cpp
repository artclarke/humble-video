...
SWIGEXPORT jlong JNICALL Java_io_humble_ferry_FerryJNI_SWIGMutexUpcast(JNIEnv *jenv, jclass jcls, jlong jarg1) {
    jlong baseptr = 0;
    (void)jenv;
    (void)jcls;
...
SWIGEXPORT jlong JNICALL Java_io_humble_ferry_FerryJNI_SWIGRefCountedTesterUpcast(JNIEnv *jenv, jclass jcls, jlong jarg1) {
    jlong baseptr = 0;
    (void)jenv;
    (void)jcls;
