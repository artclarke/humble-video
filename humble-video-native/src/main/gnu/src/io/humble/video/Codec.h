...
class VS_API_HUMBLEVIDEO CodecParameters : public io::humble::ferry::RefCounted
{
VS_JNIUTILS_REFCOUNTED_OBJECT_PRIVATE_MAKE(CodecParameters);
...
//int      extradata_size;
         ...
         */
        PixelFormat::FieldOrder getFieldOrder() const {
          return (PixelFormat::FieldOrder) mCtx->field_order;
        }
        /**
         * @see getFieldOrder()
         */
        void setFieldOrder(PixelFormat::FieldOrder order) {
         ...
         */
        PixelFormat::ColorRange getColorRange() const {
          return (PixelFormat::ColorRange) mCtx->color_range;
        }
        /**
         * @see #getColorRange()
         */
        void setColorRange(PixelFormat::ColorRange range) {
          mCtx->color_range = (enum AVColorRange) range;
        }
        /**
         * Get the color primaries. Video only.
         */
        PixelFormat::ColorPrimaries getColorPrimaries() const {
          return (PixelFormat::ColorPrimaries) mCtx->color_primaries;
        }
        /**
         * @see #getColorPrimaries()
         */
        void setColorPrimaries(PixelFormat::ColorPrimaries primaries) {
         ...
         */
        PixelFormat::ColorTransferCharacteristic getColorTransferCharacteristic() const {
          return (PixelFormat::ColorTransferCharacteristic) mCtx->color_trc;
        }
        /**
         * See #getColorTransferCharacteristic()
         */
        void setColorTransferCharacteristic(PixelFormat::ColorTransferCharacteristic trc) {
         ...
         */
        PixelFormat::ColorSpace getColorSpace() const {
          return (PixelFormat::ColorSpace) mCtx->color_space;
        }
        /**
         * @see #getColorSpace()
         */
        void setColorSpace(PixelFormat::ColorSpace space) {
         ...
         */
        PixelFormat::ChromaLocation getChromaLocation() const {
          return (PixelFormat::ChromaLocation) mCtx->chroma_location;
        }
        /**
         * @see #getChromaLocation()
         */
        void setChromaLocation(PixelFormat::ChromaLocation loc) {
         ...
         */
        int32_t getVideoDelay() const {
          return (int32_t) mCtx->video_delay;
        }
        /**
         * @see #getVideoDelay()
         */
        void setVideoDelay(int32_t delay) {
         ...
         */
        int32_t getFrameSize() const { return mCtx->frame_size; }
        /**
         * @see #getFrameSize()
         */
        void setFrameSize(int32_t size) { mCtx->frame_size = (int) size; }
         ...
         * padding.
         */
        int32_t getInitialPadding() const { return mCtx->initial_padding; }
        /**
         * @see #getInitialPadding()
         */
        void setInitialPadding(int32_t pad) { mCtx->initial_padding = (int) pad; }
         ...
         */
        int32_t getTrailingPadding() const { return mCtx->trailing_padding; }
        /**
         * @see #getTrailingPadding()
         */
        void setTrailingPadding(int32_t pad) { mCtx->trailing_padding = (int) pad; }

        /**
         * Number of samples to skip after a discontinuity. Audio only.
         */
        int32_t getSeekPreroll() const { return mCtx->seek_preroll; }
        /**
         * @see #getSeekPreroll()
         */
        void setSeekPreroll(int32_t preroll) { mCtx->seek_preroll = (int) preroll; }
