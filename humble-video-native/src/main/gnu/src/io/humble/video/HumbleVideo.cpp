...
SWIGEXPORT jint JNICALL Java_io_humble_video_VideoJNI_PixelFormat_1getFormat(JNIEnv *jenv, jclass jcls, jstring jarg1) {
  ...
  {
    /*@SWIG:/vagrant/humble-video-native/src/main/gnu/src/io/humble/video/HumbleVideo.i,139,HUMBLE_HANDLE_EXCEPTION@*/
    // HumbleVideo.i: Start generated code
    // >>>>>>>>>>>>>>>>>>>>>>>>>>>
    try
    {
...
SWIGEXPORT jlong JNICALL Java_io_humble_video_VideoJNI_Error_1SWIGUpcast(JNIEnv *jenv, jclass jcls, jlong jarg1) {
    jlong baseptr = 0;
    (void)jenv;
    (void)jcls;
